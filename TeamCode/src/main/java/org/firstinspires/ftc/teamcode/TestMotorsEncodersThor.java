...
@TeleOp(name = "--TestEncodersForThor", group = "Linear Opmode")
public class TestMotorsEncodersThor extends LinearOpMode {
    enum KurryState{
        eFind_MOTIF,
        eConfirm_MOTIF,
        eFind_POST,
    ...
    public void runOpMode() {
        ...
        while(opModeIsActive())
        {
            ...
            {
                driveStraightSingleMotor(200,true, frontRight);
            }
            if(gamepad1.bWasPressed())
            {
                driveStraightSingleMotor(200,true, frontLeft);
            }

            if(gamepad1.yWasPressed())
            {
                driveStraightSingleMotor(200,true, backLeft);
            }

            if(gamepad1.aWasPressed())
            {
                driveStraightSingleMotor(200,true, backRight);
            }
//            if(gamepad1.x) {
