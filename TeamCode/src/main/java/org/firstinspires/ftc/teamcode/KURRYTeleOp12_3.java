...
@TeleOp(name = "Bhourya", group = "Linear Opmode")
public class KurryTeleOpCopy extends LinearOpMode {
    //11/30/25
    ...
    private double rightLauncherPowerCLOSE = 0.25;
    private double leftLauncherPowerCLOSE = 0.25;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.dpad_up) {
                launcherLeft.setPower(leftLauncherPowerCLOSE);
            } else {
                launcherLeft.setPower(0);
            }

            if (gamepad2.y) {
                launcherRight.setPower(rightLauncherPowerCLOSE);
            } else {
                launcherRight.setPower(0);
            }
