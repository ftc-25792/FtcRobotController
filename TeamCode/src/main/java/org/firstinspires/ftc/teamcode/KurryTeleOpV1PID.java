...
public class KurryTeleOpV1PID extends LinearOpMode {
    ...
    private double flapperLeftPosition = 0.6;
    private double flapperRightPosition = 0.91;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // ================= FLAPPERS =================
            flapperLeft.setPosition(gamepad2.b ? 0.4 : flapperLeftPosition);
            flapperRight.setPosition(gamepad2.dpad_left ? 0.665 : flapperRightPosition);
