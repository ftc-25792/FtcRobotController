...
@TeleOp(name="Meet3_2", group="Linear Opmode")
public class Meet3_2 extends LinearOpMode {
    // Declare motors
    ...
    final double ARM_SCORE_SPECIMINS = 100 * ARM_TICKS_PER_DEGREE;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.right_bumper) {
                ...
                armPosition = ARM_SCORE_SPECIMINS;
            ...
            else if (armPosition == ARM_SCORE_IN_HIGH || armPosition == ARM_COLLECT) {
                ((DcMotorEx) armMotor).setPower(1.0);
            }
            else {
                //((DcMotorEx) armMotor).setPower(0.1);
